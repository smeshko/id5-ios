...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "AccountClient", dependencies: [entities, tca, "NetworkClient", "Endpoints", "SharedKit", "LocalStorageClient"]),
        ...
        .target(name: "MediaClient", dependencies: [tca, entities, "NetworkClient", "Endpoints", "LocalStorageClient"]),
        ...
        .target(name: "DiscoverFeature", dependencies: [
            tca, "LocationClient", "NetworkClient", "PostDetailsFeature", "PostClient","MediaClient", "SharedViews", "LocalStorageClient", "AccountClient"
        ...
        .target(name: "PostDetailsFeature", dependencies: [tca, entities, "StyleGuide", "Endpoints", "NetworkClient", "SharedKit", "PostClient", "MediaClient", "AccountClient", "SharedViews"]),
